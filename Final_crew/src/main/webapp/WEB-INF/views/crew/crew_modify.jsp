...
/* 셀렉트박스------------------------------------------------------------------------ */
                            ...
                            <tr>
                                ...
                                <td style="width: 200px;"><input type="file" name="file1" id="file1" value="${crewVo.c_filename }"></td>
                            </tr>
                            <<tr>
                                <td class="info"><span class="material-icons">upload_file</span>썸네일</td>
                                <td style="width: 200px;"><input type="file" name="file2" id="file2" value="${crewVo.c_thumbnail }"></td>
                            </tr>
                        </table>
